	...
	elseif ($choix=='1' && isset($_POST['lieu'])){
		...
		$color = "#40E0D0";
                ...
                if($_POST['Alarmej'] !="0"){
 	 		 	...
 	 		 	else		$salarme = '0000-00-00 00:00';
 	 		 	    $start = new DateTime($starts);


	$sql = "INSERT INTO events(TE,title, start, end , color, AlarmeH , AlarmeJ,AlarmeS,priority, Lieu , AlarmeHvalue , AlarmeJvalue , AlarmeSvalue ,faite , designation , id_user  ) values ('$choix','$title','$starts', '$end','$color','$halarme','$jalarme','$salarme','$priorite','$lieu','$halarmevalue','$jalarmevalue','$salarmevalue' ,'$faite','$designation' ,'$id_user')";
...
//avoir l'id de la tache
     ...
     if($_FILES['doc']['error']==UPLOAD_ERR_NO_FILE) // tester si y a pas de fichiers
     {
          ...
          $sql1 = "INSERT INTO document(designation,emplacement,id,id_user) values ('$nomdoc', '$file_destination','$id_tache','$id_user')";
